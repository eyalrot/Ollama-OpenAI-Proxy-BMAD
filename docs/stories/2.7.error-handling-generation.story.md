...
## Tasks / Subtasks
- [ ] Review error format requirements (AC: 1-6)
  - [ ] Check architecture/ollama-api-analysis.md for error format
  - [ ] Review Ollama error structure from OpenAPI spec
  - [ ] Note any special error fields or formatting
  - [ ] Check how Ollama SDK expects errors
- [ ] Create error format contract tests (AC: 1-6)
  - [ ] Test error format matches Ollama spec
  - [ ] Verify error structure for different status codes
...
- [ ] Define Ollama error response format (AC: 1-5)
  ...
  - [ ] Ensure format matches Ollama spec exactly
- [ ] Implement error translation functions (AC: 1-3)
  ...
  - [ ] Validate translated errors against spec
